...
NAMESPACE_MANIFEST = {
    'templates': '.Users.exsurgo.Work.soy-python.templates.features',
}
...
def demoComments(data={}, ijData={}):
  output = ['<!--dta_of(templates.demoComments, /Users/exsurgo/Work/soy-python/templates/features.soy, 8)-->' if False else '','blah blah<br>http://www.google.com<br>','<!--dta_cf(templates.demoComments)-->' if False else '']
...
def demoLineJoining(data={}, ijData={}):
  output = ['<!--dta_of(templates.demoLineJoining, /Users/exsurgo/Work/soy-python/templates/features.soy, 20)-->' if False else '','First second.<br><i>First</i>second.<br>Firstsecond.<br><i>First</i> second.<br>Firstsecond.<br>','<!--dta_cf(templates.demoLineJoining)-->' if False else '']
  return sanitize.SanitizedHtml(''.join(output), approval=sanitize.IActuallyUnderstandSoyTypeSafetyAndHaveSecurityApproval('Internally created Sanitization.'))
...
def demoForeach(data={}, ijData={}):
  output = []
  output.append('<!--dta_of(templates.demoForeach, /Users/exsurgo/Work/soy-python/templates/features.soy, 176)-->' if False else '')
...
def demoFor(data={}, ijData={}):
  output = []
  output.append('<!--dta_of(templates.demoFor, /Users/exsurgo/Work/soy-python/templates/features.soy, 208)-->' if False else '')
...
def demoCallWithParamBlock(data={}, ijData={}):
  output = []
  output.append('<!--dta_of(templates.demoCallWithParamBlock, /Users/exsurgo/Work/soy-python/templates/features.soy, 289)-->' if False else '')
  param175 = []
...
def demoParamWithKindAttribute(data={}, ijData={}):
  output = ['<!--dta_of(templates.demoParamWithKindAttribute, /Users/exsurgo/Work/soy-python/templates/features.soy, 339)-->' if False else '','<div>']
  param221 = []
...
def demoParamWithKindAttributeCallee_(data={}, ijData={}):
  output = ['<!--dta_of(templates.demoParamWithKindAttributeCallee_, /Users/exsurgo/Work/soy-python/templates/features.soy, 364)-->' if False else '','<div>',str(sanitize.escape_html(data.get('message'))),'</div><ol>',str(sanitize.escape_html(data.get('listItems'))),'</ol>','<!--dta_cf(templates.demoParamWithKindAttributeCallee_)-->' if False else '']
  return sanitize.SanitizedHtml(''.join(output), approval=sanitize.IActuallyUnderstandSoyTypeSafetyAndHaveSecurityApproval('Internally created Sanitization.'))


def demoExpressions(data={}, ijData={}):
  output = ['<!--dta_of(templates.demoExpressions, /Users/exsurgo/Work/soy-python/templates/features.soy, 381)-->' if False else '','First student\'s major: ',str(sanitize.escape_html(runtime.key_safe_data_access(data.get('students'), 0).get('major'))),'<br>Last student\'s year: ',str(sanitize.escape_html(runtime.key_safe_data_access(data.get('students'), len(data.get('students')) - 1).get('year'))),'<br>Random student\'s major: ',str(sanitize.escape_html(runtime.key_safe_data_access(data.get('students'), random.randint(0, len(data.get('students')) - 1)).get('major'))),'<br>']
...
def exampleHeader(data={}, ijData={}):
  output = ['<!--dta_of(templates.exampleHeader, /Users/exsurgo/Work/soy-python/templates/features.soy, 540)-->' if False else '','<hr><b>',str(sanitize.escape_html(data.get('exampleNum'))),'. ',str(sanitize.escape_html(data.get('exampleName'))),'</b><br>','<!--dta_cf(templates.exampleHeader)-->' if False else '']
  return sanitize.SanitizedHtml(''.join(output), approval=sanitize.IActuallyUnderstandSoyTypeSafetyAndHaveSecurityApproval('Internally created Sanitization.'))
